...
% Last Modified by GUIDE v2.5 12-Apr-2022 20:48:37
...
switch v
  case 'off'
    ...
    set(APPLICATION.views{nv}, 'outerposition',[282 155 545 584]);
...
switch v
  case 'off'
    APPLICATION.visualiser=APPLICATION.visualiser.loadCamera(nv);
    set(APPLICATION.views{nv},'visible','on');
    set(APPLICATION.views{nv}, 'outerposition',[482 155 545 584]);
		APPLICATION.visualiser.updateView(nv);
  case 'on'
    set(APPLICATION.views{nv},'visible','off');
end
...
%close all;
%delete(APPLICATION.handles.figure1)
delete(hObject)
%clear('APPLICATION');
%clear all;
